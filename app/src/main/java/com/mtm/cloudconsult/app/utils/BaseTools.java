...
public class BaseTools {
    ...
    public static String getVersionName() {
        // 获取packagemanager的实例
        PackageManager packageManager = BaseAppliction.getInstance().getPackageManager();
        // getPackageName()是你当前类的包名，0代表是获取版本信息
        PackageInfo packInfo = null;
        try {
            packInfo = packageManager.getPackageInfo(BaseAppliction.getInstance().getPackageName(), 0);
    ...
    public static void copy(String content) {
        // 得到剪贴板管理器
        ClipboardManager cmb = (ClipboardManager) BaseAppliction.getInstance().getSystemService(Context.CLIPBOARD_SERVICE);
