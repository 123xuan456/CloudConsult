...
public interface Api {
    ...
    String API_BIZHI = "http://service.picasso.adesk.com/";
    String API_WECHAT = "http://api.tianapi.com/";
    String API_GAMER = "http://appapi2.gamersky.com/";
    ...
    String BIZHI_DOMAIN_NAME = "bizhi";
    String WECHAT_DOMAIN_NAME = "wechat";
    String GAMER_DOMAIN_NAME = "gamerSky";
